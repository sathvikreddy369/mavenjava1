...
TUNEORA – A Music Web App
1. Sequence Diagram: A sequence diagram shows how objects interact in a particular scenario of a use case. It focuses on the time order of messages exchanged between different components in a system.


2. Class Diagram: A class diagram represents the static structure of a system by showing classes, their attributes, methods, and relationships. It is mainly used for object-oriented design and modeling data structures.


3. Component Diagram: A component diagram illustrates how different software components are connected and interact to form a complete system. It helps visualize the organization and dependencies among modules or subsystems.
